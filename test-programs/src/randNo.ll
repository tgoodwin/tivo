...
@.str = private unnamed_addr constant [34 x i8] c"The randomly generated number is \00", align 1
...
define i32 @main() #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0))
  %5 = call i32 @rand()
